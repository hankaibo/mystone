...
import compack from './compact';
import countBy from './countBy';
import countOccurrences from './countOccurrences';
import deepFlatten from './deepFlatten';
import diffenrence from './diffenrence';
import diffenrenceBy from './diffenrenceBy';
import diffenrenceWith from './diffenrenceWith';
...
mystone.compact = compack;
mystone.countBy = countBy;
mystone.countOccurrences = countOccurrences;
mystone.deepFlatten = deepFlatten;
mystone.diffenrence = diffenrence;
mystone.diffenrenceBy = diffenrenceBy;
mystone.diffenrenceWith = diffenrenceWith;
mystone.drop = drop;
